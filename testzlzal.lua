...
if hash or DevBot(msg) or Devtestzlzal(msg) or VIP_DeV(msg) or BasicConstructor(msg) or Constructor(msg) or creator(msg) or Owner(msg)  or creators(msg) then       
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Devtestzlzal(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) or creators(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or Devtestzlzal(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) or creators(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Devtestzlzal(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) or creators(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or Devtestzlzal(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) or creators(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  Devtestzlzal(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) or creators(msg) then             
return true 
else 
return false 
end 
...
local testzlzal_Msg = database:get(bot_id.."testzlzal:Add:Filter:Rp2"..text..msg.chat_id_)   
if testzlzal_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","℘ : "..testzlzal_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
local num = database:smembers(bot_id.."testzlzal:allM"..msg.chat_id_)
...
local list = database:smembers(bot_id.."testzlzal:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."testzlzal:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."testzlzal:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."testzlzal:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n℘ : قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local testzlzal_Msg = database:get(bot_id.."testzlzal:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..testzlzal_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."testzlzal:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."testzlzal:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."testzlzal:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."testzlzal:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."testzlzal:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."testzlzal:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."testzlzal:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."testzlzal:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."testzlzal:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."testzlzal:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local UserName = (b.username_ or "testzlzalTEAM")
...
database:sadd(bot_id.."testzlzal:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
if text == (database:get(bot_id.."testzlzal:Name:Bot") or "بيكا") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."testzlzal:Name:Bot") or "بيكا")
local namebot = {
...
database:set(bot_id.."testzlzal:Klesh:Id:Bot"..msg.chat_id_,Text_Rand)
...
local NumMsg = database:get(bot_id..'testzlzal:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."testzlzal:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'testzlzal:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
if text == 'id' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'testzlzal:Lock:ID:Bot'..msg.chat_id_) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and not database:get(bot_id..'testzlzal:Lock:ID:Bot'..msg.chat_id_) then
function Function_testzlzal(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,'℘ :  الحساب محذوف لا توجد معلوماته ')
...
if text and text:match("^كشف @(.*)$")  and not database:get(bot_id..'testzlzal:Lock:ID:Bot'..msg.chat_id_) then
...
os.execute('wget https://raw.githubusercontent.com/Source-Becca/testzlzal/master/testzlzal.lua')
os.execute('wget https://raw.githubusercontent.com/Source-Becca/testzlzal/master/start.lua')
...
if not Devtestzlzal(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if text and text:match("^- ◞تغير الاشتراك◜ .$") and Devtestzlzal(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- ◞تغير رساله الاشتراك◜ .$") and Devtestzlzal(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "◞حذف رساله الاشتراك◜ ." and Devtestzlzal(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "܁༯┆تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^◞تعين قناة الاشتراك◜$") and Devtestzlzal(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '܁༯┆حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- ◞تفعيل الاشتراك الاجباري◜ ." and Devtestzlzal(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- ◞تعطيل الاشتراك الاجباري◜ ." and Devtestzlzal(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "܁༯┆تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- ◞الاشتراك الاجباري◜ ." and Devtestzlzal(msg) then  
...
local Name_Bot = (database:get(bot_id.."testzlzal:Name:Bot") or "بيكا")
...
------------------------------------------------------------------------
if text then
local testzlzal_Msg = database:get(bot_id.."testzlzal:Add:Filter:Rp2"..text..result.chat_id_)   
if testzlzal_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","℘ : "..testzlzal_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
